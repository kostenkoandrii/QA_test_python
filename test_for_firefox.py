...
submit_child_quantity = driver.find_element_by_css_selector("[aria-label='Increase number of Children']")
...
submit_open_date = driver.find_element_by_css_selector("[data-placeholder='Check-out Date']")
